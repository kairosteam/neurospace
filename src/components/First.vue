<template>
    <v-app style="background-color: #242933;" transition="fade-transition">
        <v-toolbar class="elevation-5" style="background-color: #242933;" >
            ...
            <v-btn flat light class="white--text tbtn">The problem</v-btn>
        ...
        <main>
            ...
            <v-layout row wrap align-center justify-center  >
                ...
                <v-flex xs12 lg6 class="pa-0">
                    <img class="ns hidden-md-and-down" src="../assets/nslogo.png" style="width: auto; height: 500px; padding-top: 100px; -webkit-filter: drop-shadow(0px 0px 50px #8dfbea);">
                    <img class="ns hidden-md-and-up" src="../assets/nslogo.png" style="width: auto; height: 380px; padding-top: 100px; -webkit-filter: drop-shadow(0px 0px 50px #8dfbea);">
                </v-flex>
                <v-flex xs12 lg6>
                    <div class="ns hidden-md-and-down" style="margin-top: 170px">Neurospace</div>
                    <div class="ns hidden-md-and-up" style="margin-top: -10px">Neurospace</div>
                    <div class="sub-ns" style="margin-top: -20px; margin-bottom: 30px">The wearable of your dreams</div>
